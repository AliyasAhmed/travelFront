...
//             setResponseContent(formattedText); // Update `responseContent`
...
//above working code , below code is for the new changes
// import React, { useState, useEffect, useContext } from 'react';
// import { FaRegUserCircle } from 'react-icons/fa';
// import { MdOutlineAddPhotoAlternate } from 'react-icons/md';
// import { GrMicrophone } from 'react-icons/gr';
...
//     // Format response text and include images... working
...
//             // Insert an image after every 3rd paragraph or based on index
//             if (images[index]) {
//                 formattedText += `<img src="${images[index]}" alt="Image ${index + 1}" style="max-width: 100%; margin: 10px 0;" />`;
//             }
//         });
...
//             const responseWords = formattedText.split(' ');
//             setResponseContent(formattedText);
