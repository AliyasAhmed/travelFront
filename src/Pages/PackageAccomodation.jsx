...
const PackageAccomodation = () => {
  ...
  return (
    <main className="flex flex-col md:flex-row h-screen  text-white">
      ...
      {/* Right Section */}
      <section id="rightSection" className="flex-1 p-4 overflow-auto">
        {activeTab === 1 && <PackageAccomodationContent />}
...
export default PackageAccomodation;
