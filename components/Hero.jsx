    ...
    <section className="relative text-white ">
      ...
      <div className="text-center max-w-4xl px-6 mx-auto mt-36 mb-24 ">
        <h1 className="text-3xl md:text-5xl leading-tight font-inter font-semibold">
          Travel Buddy for
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A96F44] to-[#F2ECB6]">
            {" "}
            AI
          </span>{" "}
          Era
        ...
        <p className="mt-4 text-lg md:text-xl text-gray-200">
          Visualize, communicate, and iterate on wireframes and prototypes in
          minutes. Empower your product team with AI!
        </p>
