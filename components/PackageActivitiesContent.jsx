...
//     // useState declaration for storing activities
//     const [activities, setActivities] = useState([...activities,])

//     const storeActivities=(e)=>{
...
//                     </div>
//                     {/* input field */}
//                     <input type="text" name="" id="" placeholder='Type or search for activities' className='placeholder:font-bold p-3 rounded-lg' value={activities} onChange={setActivities} />
