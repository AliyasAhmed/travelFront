                ...
                <div className="p-5 pb-10 flex flex-col gap-5">
                    <div>
                        <textarea
                            ...
                            className="w-full h-32 p-3 border rounded-lg text-slate-700"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-5">
                        {/* Card 1 */}
                        <div
                            className="h-[200px] p-4 bg-gradient-to-b from-green-400 rounded-lg relative cursor-pointer hover:bg-gray-300"
                            onClick={() => setInput('Give me a travel package of 3 days for Kashmir')}
                        >
                        ...
                        <div
                            className="h-[200px] p-4 bg-gradient-to-b from-green-400 rounded-lg relative cursor-pointer hover:bg-gray-300"
                            onClick={() => setInput('Give me a travel package for Ladakh')}
                        >
                            <p className="text-slate-700 text-lg">Give me a travel package for Ladakh</p>
                        </div>
                        ...
                        <div
                            className="h-[200px] p-4 bg-gradient-to-b from-green-400 rounded-lg relative cursor-pointer hover:bg-gray-300"
                            onClick={() => setInput('What’s the weather like today at Ladakh?')}
                        >
                            <p className="text-slate-700 text-lg">What’s the weather like today at Ladakh?</p>
                        </div>
                        ...
                        <div
                            className="h-[200px] p-4 bg-gradient-to-b from-green-400 rounded-lg relative cursor-pointer hover:bg-gray-300"
                            onClick={() => setInput('What are the main goals of tourism at Kashmir?')}
                        >
                            <p className="text-slate-700 text-lg">What are the main goals of tourism at Kashmir?</p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center items-center">
                        <button
                            onClick={sendPrompt}
                            className="flex gap-3 items-center py-3 px-5 text-white rounded-full bg-gradient-to-r from-[#81cafe] to-[#A96F44]">
